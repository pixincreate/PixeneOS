...
VERSION[ALTERINSTALLER]="${VERSION[ALTERINSTALLER]:-2.1}"
VERSION[AVBROOT]="${VERSION[AVBROOT]:-3.21.0}"
VERSION[AVBROOT_SETUP]="16636c3" # Commit hash
VERSION[BCR]="${VERSION[BCR]:-1.79}"
VERSION[CUSTOTA]="${VERSION[CUSTOTA]:-5.15}"
VERSION[GRAPHENEOS]="${VERSION[GRAPHENEOS]:-}"
VERSION[MAGISK]="${VERSION[MAGISK]:-}"
VERSION[MSD]="${VERSION[MSD]:-1.15}"
VERSION[OEMUNLOCKONBOOT]="${VERSION[OEMUNLOCKONBOOT]:-1.2}"
