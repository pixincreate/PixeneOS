...
VERSION[AVBROOT]="${VERSION[AVBROOT]:-3.30.1}"
VERSION[AVBROOT_SETUP]="e74fef42b5a5e71f0d6c0772dafd715b5e5a2a9c" # Commit hash
VERSION[BCR]="${VERSION[BCR]:-3.2}"
VERSION[CUSTOTA]="${VERSION[CUSTOTA]:-6.1}"
VERSION[GRAPHENEOS]="${VERSION[GRAPHENEOS]:-}"
VERSION[MAGISK]="${VERSION[MAGISK]:-}"
VERSION[MSD]="${VERSION[MSD]:-2.1}"
