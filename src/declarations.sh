...
VERSION[AVBROOT]="${VERSION[AVBROOT]:-3.11.0}"
VERSION[ALTERINSTALLER]="${VERSION[ALTERINSTALLER]:-2.0}"
VERSION[CUSTOTA]="${VERSION[CUSTOTA]:-5.4}"
VERSION[MSD]="${VERSION[MSD]:-1.8}"
VERSION[BCR]="${VERSION[BCR]:-1.74}"
VERSION[CHARGELIMIT]="${VERSION[CHARGELIMIT]:-1.0}"
...
ADDITIONALS[CHARGELIMIT]="${ADDITIONALS[CHARGELIMIT]:-true}"           # Limit charging to 80% (Quick tile toggle)
